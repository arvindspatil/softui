...
import EditSavingsTransaction from './EditSavingsTransaction'

const SavingsTransactionTable = ({ transactions, deleteTransaction, acctName, selOptions, allOptions, updateTransaction }) => {
    ...
    return (
        <>
            {showEditTransaction && <EditSavingsTransaction
