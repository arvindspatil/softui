...
import EditUploadedSavingsTransaction from './EditUploadedSavingsTransaction'

const UploadedSavingsTransactionTable = ({ transactions, deleteTransaction, acctName, selOptions, allOptions, updateTransaction }) => {
    ...
    return (
        <>
            {showEditTransaction && <EditUploadedSavingsTransaction
...
export default UploadedSavingsTransactionTable
